...
import codingcareers.webapp.client.PageComponents.PageComponent;
import codingcareers.webapp.client.PageComponents.PageComposite;

public class Controller{
	private PageComposite view;
	private Model model;
	...
	//TODO: loadTaskPage(taskID: int): void
	...
	//TODO: - loadPage(page: PageComponent): void
	private void loadPage(PageComponent page){
		return;
	}
