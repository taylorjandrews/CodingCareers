package codingcareers.webapp.client.ace;
...
public class AceCommandDescription {
	...
	public static native AceCommandDescription fromJavaScript(JavaScriptObject obj) /*-{
		var name = obj.name;
		var exec = @codingcareers.webapp.client.ace.AceCommandDescription::createJavaScriptWrapper(Ljava/lang/Object;)(obj.exec);
		var ret = @codingcareers.webapp.client.ace.AceCommandDescription::new(Ljava/lang/String;Lcodingcareers/webapp/client/ace/AceCommandDescription$ExecAction;)(name, exec);
		var bindKey = @codingcareers.webapp.client.ace.AceCommandDescription.KeyBinding::fromJavaScript(Ljava/lang/Object;)(obj.bindKey);
		if (bindKey)
			ret.@codingcareers.webapp.client.ace.AceCommandDescription::withBindKey(Lcodingcareers/webapp/client/ace/AceCommandDescription$KeyBinding;)(bindKey);
		var readOnly = obj.readOnly;
		if (readOnly)
			ret.@codingcareers.webapp.client.ace.AceCommandDescription::withReadOnly(Z)(readOnly);
		var passEvent = obj.passEvent;
		if (passEvent)
			ret.@codingcareers.webapp.client.ace.AceCommandDescription::withPassEvent(Z)(passEvent);
		var scrollIntoView = @codingcareers.webapp.client.ace.AceCommandDescription.ScrollIntoView::fromString(Ljava/lang/String;)(obj.scrollIntoView);
		if (scrollIntoView)
			ret.@codingcareers.webapp.client.ace.AceCommandDescription::withScrollIntoView(Lcodingcareers/webapp/client/ace/AceCommandDescription$ScrollIntoView;)(scrollIntoView);
		var objMultiSelectAction = obj.multiSelectAction;
		var multiSelectAction = null;
		if (typeof objMultiSelectAction === "string")
			multiSelectAction = @codingcareers.webapp.client.ace.AceCommandDescription.MultiSelectAction::fromString(Ljava/lang/String;)(objMultiSelectAction);
		if (multiSelectAction)
			ret.@codingcareers.webapp.client.ace.AceCommandDescription::withMultiSelectAction(Lcodingcareers/webapp/client/ace/AceCommandDescription$MultiSelectAction;)(multiSelectAction);
		var aceCommandGroup = obj.aceCommandGroup;
		if (aceCommandGroup)
			ret.@codingcareers.webapp.client.ace.AceCommandDescription::withAceCommandGroup(Ljava/lang/String;)(aceCommandGroup);
		return ret;
	}-*/;
	...
	private static native Object invokeJavaScriptCommand(Object jsFunction, AceEditor javaWrapper) /*-{
		var jsEditor = javaWrapper.@codingcareers.webapp.client.ace.AceEditor::editor;
	...
	public native JavaScriptObject toJavaScript(AceEditor editor) /*-{
		var ret = {};
		ret['name'] = this.@codingcareers.webapp.client.ace.AceCommandDescription::name;
		var javaExec = this.@codingcareers.webapp.client.ace.AceCommandDescription::exec;
		ret['exec'] = function() {
			javaExec.@codingcareers.webapp.client.ace.AceCommandDescription.ExecAction::exec(Lcodingcareers/webapp/client/ace/AceEditor;)(editor);
		};
		var bindKey = this.@codingcareers.webapp.client.ace.AceCommandDescription::bindKey;
		if (bindKey)
			ret['bindKey'] = bindKey.@codingcareers.webapp.client.ace.AceCommandDescription.KeyBinding::toJavaScript()();
		var readOnly = this.@codingcareers.webapp.client.ace.AceCommandDescription::readOnly;
		if (readOnly)
			ret['readOnly'] = readOnly;
		var passEvent = this.@codingcareers.webapp.client.ace.AceCommandDescription::passEvent;
		if (passEvent) 
			ret['passEvent'] = passEvent;
		var scrollIntoView = this.@codingcareers.webapp.client.ace.AceCommandDescription::scrollIntoView;
		if (scrollIntoView)
			ret['scrollIntoView'] = scrollIntoView.@codingcareers.webapp.client.ace.AceCommandDescription.ScrollIntoView::name()();
		var multiSelectAction = this.@codingcareers.webapp.client.ace.AceCommandDescription::multiSelectAction;
		if (multiSelectAction)
			ret['multiSelectAction'] = multiSelectAction.@codingcareers.webapp.client.ace.AceCommandDescription.MultiSelectAction::name()();
		var aceCommandGroup = this.@codingcareers.webapp.client.ace.AceCommandDescription::aceCommandGroup;
		if (aceCommandGroup)
	...
	public static class KeyBinding {
		...
		private static native KeyBinding fromJavaScript(Object obj) /*-{
			...
			if (typeof obj === "string")
				return @codingcareers.webapp.client.ace.AceCommandDescription.KeyBinding::new(Ljava/lang/String;)(obj);
			return @codingcareers.webapp.client.ace.AceCommandDescription.KeyBinding::new(Ljava/lang/String;Ljava/lang/String;)(obj.win, obj.mac);
		}-*/;

		private native Object toJavaScript() /*-{
			var ret = this.@codingcareers.webapp.client.ace.AceCommandDescription.KeyBinding::allPlatforms;
			if (ret)
				return ret;
			var win = this.@codingcareers.webapp.client.ace.AceCommandDescription.KeyBinding::exceptMac;
			var mac = this.@codingcareers.webapp.client.ace.AceCommandDescription.KeyBinding::mac;
