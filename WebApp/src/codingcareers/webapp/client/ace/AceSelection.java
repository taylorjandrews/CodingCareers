...
public class AceSelection {
	...
	private static native void registerRootListener(JavaScriptObject selection, AceSelectionListener rootListener) /*-{
		selection.addEventListener("changeSelection", function() {
			rootListener.@codingcareers.webapp.client.ace.AceSelectionListener::onChangeSelection(Lcodingcareers/webapp/client/ace/AceSelection;)(null);
		});
	}-*/;
	...
	public native boolean isEmpty() /*-{
		return this.@codingcareers.webapp.client.ace.AceSelection::selection.isEmpty();
	}-*/;
	...
	public native boolean isMultiLine() /*-{
		return this.@codingcareers.webapp.client.ace.AceSelection::selection.isMultiLine();
	}-*/;
	...
	public native AceEditorCursorPosition getSelectionLead() /*-{
		var pos = this.@codingcareers.webapp.client.ace.AceSelection::selection.getSelectionLead();
		return this.@codingcareers.webapp.client.ace.AceSelection::getCursorPositionImpl(DD)(pos.row, pos.column);
	}-*/;
	...
	public native AceEditorCursorPosition getSelectionAnchor() /*-{
		var pos = this.@codingcareers.webapp.client.ace.AceSelection::selection.getSelectionAnchor();
		return this.@codingcareers.webapp.client.ace.AceSelection::getCursorPositionImpl(DD)(pos.row, pos.column);
	}-*/;
	...
	public native boolean isBackwards() /*-{
		return this.@codingcareers.webapp.client.ace.AceSelection::selection.isBackwards();
	}-*/;
	...
	public native void clearSelection() /*-{
		this.@codingcareers.webapp.client.ace.AceSelection::selection.clearSelection();
	}-*/;
	...
	public native void selectAll() /*-{
		this.@codingcareers.webapp.client.ace.AceSelection::selection.selectAll();
	}-*/;
	...
	public native void select(int fromRow, int fromColumn, int toRow, int toColumn) /*-{
		this.@codingcareers.webapp.client.ace.AceSelection::selection.setSelectionAnchor(fromRow, fromColumn);
		this.@codingcareers.webapp.client.ace.AceSelection::selection.selectTo(toRow, toColumn);
	}-*/;
	...
	public native void selectLine() /*-{
		var s = this.@codingcareers.webapp.client.ace.AceSelection::selection;
